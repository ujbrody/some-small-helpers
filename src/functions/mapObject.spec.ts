...
describe('mapObject', () => {
  ...
  it('applies the mapper on all properties of an object', () => {
    ...
    const result = mapObject(obj, stringMapper);
  ...
  it('applies the mapper on all cell in array', () => {
    ...
    const result = mapObject(arr, stringMapper);
  ...
  it('does not apply the mapper on any argument that is not array or object with properties', () => {
    ...
    const result = mapObject(num, stringMapper);
  ...
  it.skip('does not apply the mapper on sub fields that are empty values', () => {
    ...
    const result = mapObject(obj, (val) => `${val}o`);
  ...
  it.skip('only applies the mapping on properties that fulfill the predicate', () => {
    ...
    const result = mapObject(obj, stringMapper, predicate);
  ...
  it.skip('only applies the mapping on array cells that fulfill the predicate', () => {
    ...
    const result = mapObject(arr, stringMapper, predicate);
  ...
  it.skip('able to treat only fields identified as Date in a complex object that has empty fields (edge case)', () => {
    ...
    const result = mapObject(obj, (date: Date) => new Date(date.getFullYear(), date.getMonth(), date.getDate()), (val) => val instanceof Date);
